...
class _OrdersScreenState extends State<OrdersScreen>
  ...
  void _initializeCartService() {
    ...
    _availableCartsSubscription =
        _cartService.availableCartsStream.listen((_) {});

    _unpaidInvoicesSubscription =
        _cartService.unpaidInvoicesStream.listen((invoices) {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> filters =
        isDelegate ? [..._filters, 'الفواتير'] : List.of(_filters);
  ...
  Future<void> _callCustomer(Cart cart) async {
    ...
    try {
      String phoneNumber =
          cart.customerPhone!.replaceAll(RegExp(r'[^\d+]'), '');
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('المستحق: ${due.toStringAsFixed(2)}',
