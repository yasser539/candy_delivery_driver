                      ...
                      child: Column(
                        ...
                        children: [
                          FaIcon(FontAwesomeIcons.users,
                              color: DesignSystem.textSecondary, size: 40),
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Text('${(c.rating ?? 0).toStringAsFixed(1)}',
                    style: DesignSystem.labelSmall
          ...
          Row(children: [
            ...
            Expanded(
                child: Text(c.email,
                    style: DesignSystem.bodySmall, textAlign: TextAlign.left)),
          ]),
          const SizedBox(height: 10),
          Row(children: [
        ...
        child: Column(children: [
          Text(value,
              style: DesignSystem.titleSmall.copyWith(
                  fontWeight: FontWeight.bold, color: DesignSystem.primary)),
...
class _CaptainFormState extends State<_CaptainForm> {
  ...
  void _submit() {
    ...
    final payload = <String, dynamic>{
      ...
      'vehicle_plate':
          _vehiclePlate.text.trim().isEmpty ? null : _vehiclePlate.text.trim(),
      'profile_image':
          _profileImage.text.trim().isEmpty ? null : _profileImage.text.trim(),
    };
