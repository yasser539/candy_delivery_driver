class DeliveryCaptain {
  ...
  factory DeliveryCaptain.fromMap(Map<String, dynamic> map) {
    ...
    return DeliveryCaptain(
      ...
      totalEarnings: _toDouble(map['total_earnings']),
      ...
      joinDate: _toDate(map['join_date']),
      contractStartDate: _toDate(map['contract_start_date']),
      contractEndDate: _toDate(map['contract_end_date']),
      salary: _toDouble(map['salary']),
      commissionRate: _toDouble(map['commission_rate']),
      deviceId: map['device_id'],
      appVersion: map['app_version'],
      lastActive: _toDate(map['last_active']),
      isVerified: map['is_verified'] == null
          ? null
          : (map['is_verified'] is bool
              ? map['is_verified'] as bool
              : map['is_verified'].toString().toLowerCase() == 'true'),
      verificationDate: _toDate(map['verification_date']),
