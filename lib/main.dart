...
// import 'screens/auth/login_screen.dart'; // unused, SplashScreen handles routing
...
void main() async {
  ...
  // Initialize app settings before running the app so theme is applied immediately
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<AppSettings, AuthService>(
